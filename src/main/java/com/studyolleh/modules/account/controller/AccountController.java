package com.studyolleh.modules.account.controller;
...
import com.studyolleh.modules.account.validator.SignUpFormValidator;
...
public class AccountController {
    ...
    public String viewProfile(@PathVariable String nickname, Model model, @CurrentAccount Account account) {
        Account viewAccount = accountService.getAccount(nickname);
        model.addAttribute(viewAccount);
