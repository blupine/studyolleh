...
operation::user-login-success[snippets='http-request,http-response,request-fields,response-fields,links']

[[user-login-fail]]
=== 로그인 실패

operation::user-login-fail[snippets='http-request,http-response,request-fields,response-fields,links']

[[check-email-token]]
=== 이메일 인증

operation::check-email-token[snippets='request-parameters,response-fields,links']
